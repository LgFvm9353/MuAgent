...
class ContextBuilder:
    ...
    def domain_expert(self, task: TaskContract, tool_catalog: tuple[dict[str, Any], ...]) -> dict[str, Any]:
        return {
            "goal": task.goal,
            "constraints": task.constraints,
    ...
    def judge(self, proposals: tuple[dict[str, Any], ...], critiques: tuple[dict[str, Any], ...]) -> dict[str, Any]:
        return {"proposals": proposals, "critiques": critiques}

    def planner(self, decision: dict[str, Any], tool_catalog: tuple[dict[str, Any], ...]) -> dict[str, Any]:
        return {"approved_decision": decision, "tool_catalog": tool_catalog}

    def verifier(self, task: TaskContract, plan: dict[str, Any], execution: tuple[dict[str, Any], ...], evidence: tuple[dict[str, Any], ...]) -> dict[str, Any]:
        return {
            "acceptance_criteria": [item.model_dump(mode="json") for item in task.acceptance_criteria],
            "approved_plan": plan,
